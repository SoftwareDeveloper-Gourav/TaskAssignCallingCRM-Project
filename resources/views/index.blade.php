          ...
          <div class="container">
            <div class="site-navbar">
              <div class="row align-items-center">
                <div
                  class="col-lg-2 col-md-6 col-9 order-2 order-xl-1 order-lg-1 order-md-1"
                >
                ...
                <div
                  class="col-lg-6 col-md-1 col-3 order-3 order-xl-2 order-lg-2 order-md-3 pl-xs-0"
                >
            ...
            <div class="col-md-12">
              <div class="hero-slider-item">
                <div class="row">
                  ...
                  <div
                    class="col-xl-4 offset-xl-2 col-lg-5 offset-lg-1 col-md-12"
                  >
                      ...
                      <form class="hero__form v3 filter listing-filter" id="user_details_form">
                        ...
                        <div class="row">
                          <div class="col-md-12 mb-3">
                           ...
                           <div class="col-md-12 mb-3">
                          <div class="input-man">
                           <input type="tel" id="phone" class="form-control" name="phone" placeholder="Type Your Mobile Number"  required style="width: 387px; height: 45px;">
                          ...
                          {{@csrf_field()}}
                           <div class="col-md-12 mb-3">
                             ...
                             <textarea name="msg" id="" cols="30" rows="3" placeholder="Type Message Here.." class="form-control" required></textarea>
                          </div>
                        
                          <div class="col-sm-12">
                            <div class="search_btn">
                              <button type="submit" id="btn" onclick="FormSubmit()">Submit
                              </button>
