...
<!---------------------------------------------------------
 *  Copyright (c) Azorizak. All rights reserved.
 *  Licensed under the MIT License. 
 *  Project Name: HTML CSS JS PHONE
 *  Project Type: Html Css Js
 *  Author: Aziz ORAK
 *  Author-URL: instagram.com/azorizak
 *  Date: -.-.2023
 *  Description: HTML CSS JS PHONE
 *-------------------------------------------------------->
<div class="general">
  <div class="buttons">
  ...
  <div class="phone">
    <div class="screen">
        ...
        <button id="button-call"  class="btn btn-success" style="border-radius: 45px; margin-top: 280px; padding: 20px 45px 42px 50px; display:none;"> <i class="fa fa-phone" aria-hidden="true"></i></button>
            <button id="button-hangup"  class="btn btn-danger" style="border-radius: 45px; margin-top: 280px; padding: 20px 45px 42px 50px"> <i class="fa fa-power-off" aria-hidden="true"></i></button>
        </div>
      <div class="camera">
        <div class="cam-l">
          <div class="fx-l-1">
