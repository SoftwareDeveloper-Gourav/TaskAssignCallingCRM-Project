...
<!--End Back To Top Button-->
            <footer class="page-footer">
                <p class="mb-0">Copyright © 2023. Design & Developed By <b><a target="_blank" href="{{url('https://kyptronix.us')}}">Kyptronix LLP</a></b></p>
            </footer>
        </div>
        <!--end wrapper-->
        ...
        <script src="{{url('project-js/team/password.js')}}"></script>
        <script src="{{url('project-js/team/contact.js')}}"></script>
    ...
    <!-- Mirrored from codervent.com/syndron/demo/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Jun 2023 07:08:46 GMT -->
</html>
