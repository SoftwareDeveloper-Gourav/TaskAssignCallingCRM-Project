        ...
        <div class="wrapper">
            ...
            <div class="sidebar-wrapper" data-simplebar="true">
                ...
                <ul class="metismenu" id="menu">
                    <li id="dashboard">
                    	...
                    	<li>
					<a class="" href="{{route('team.change_username')}}">
						<div class="parent-icon"><i class='bx bx-message-square-edit'></i>
						</div>
						<div class="menu-title">Update Details</div>
					</a>
				 </li>
                    <li id="change_password">
                        <a  href="{{route('team.change-password')}}">
                    ...
                    <li>
					<a href="{{route('team.add-customer')}}">
                 ...
                 <li>
					<a class="" href="{{route('team.customer')}}">
            ...
            <a class="" href="{{route('team.sms')}}">
              ...
              <div class="menu-title">Sending SMS</div>
                    	...
                    	<li>
					<a class="" href="{{route('team-logout')}}">
                ...
                <div class="topbar d-flex align-items-center">
                    <nav class="navbar navbar-expand gap-3">
                        ...
                        <div class="user-box dropdown px-3">
                            ...
                            >
                                <img
                                    src="{{url('assets/images/team.png')}}"
                                    class="user-img"
                                    alt="user avatar"
                                />
                                <div class="user-info">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a
                                        ...
                                        href="{{route('team.change_username')}}"
                                ...
                                <li>
                                    <a
                                        class="dropdown-item d-flex align-items-center"
                                        href="{{route('team.change-password')}}"
