@if(session('team'))
<script>
    window.location="/team/dashboard";
</script>
@endif
<!doctype html>
<html lang="en">
						...
						<div class="card rounded-0 m-3 shadow-none bg-transparent mb-0">
							<div class="card-body p-sm-5">
								<div class="">
									...
									<div class="form-body">
										<form id="team_login_form" class="row g-3">
											<div class="col-12">
												<label for="inputEmailAddress" class="form-label">Email Or Mobile No</label>
												<input type="text" name="email_phone" class="form-control" id="inputEmailAddress" placeholder="Type Email Or Number Here">
											</div>
											{{@csrf_field()}}
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">Password</label>
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" name="password" id="inputChoosePassword" placeholder="*******"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
												</div>
											</div>
{{-- 										
	...
	<!--Password show & hide js -->
	  <script src="{{url('project-js/jquery.js')}}"></script>
        ...
        <script src="{{url('project-js/sweetalert.js')}}"></script>
			...
			<script src="{{url('project-js/team/login.js')}}"></script>
	<script>
